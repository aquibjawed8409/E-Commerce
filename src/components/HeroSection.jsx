...
const HeroSection = ({ title }) => {
  return (
    <>
      <div className="flex flex-col-reverse mt-10 justify-center items-center md:flex md:flex-row md:w-[80%] md:m-auto md:mt-10">
        <div className="flex flex-col my-3 w-[80%] m-auto md:w-[40%]">
          ...
          <p className="mb-5">
            ...
            minus officia dolor deleniti veritatis perferendis reprehenderit
            fuga, sit necessitatibus hic amet.
          </p>
          <NavLink to="/products">
